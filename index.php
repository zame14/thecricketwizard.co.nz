...
<meta name="keywords" content="online cricket management system,cricket management system,cricket wizard,cricket statistics,cricket advertising" />
	...
	if($_REQUEST['action']=="login"){
		...
		if($error==0){
			...
			if($result[1]['message']=="team registered by user"){
				...
				//email admin@thecricketwizard.co.nz that new team has registered
				emails("newteam", "", "", $_REQUEST['teamname'], "", "","");
...
<table cellpadding="0" cellspacing="0" width="100%" bgcolor="#CCCCCC" border="0" height="100%">
	<tr>
		...
		<tr>
			<td style="padding-top:50px; padding-bottom:30px;" align="center" id="indextext" width="65%">Your Online Cricket Management System</td>
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" width="650" id="thumbnails1" border="0">
				<tr>
					<td colspan="7" style="padding-left:5px; padding-bottom:10px; font-size:18px" id="whitetext">Click on the thumbnails below to view page previews.</td>
				</tr>
				<tr>
			...
			<td align="center"><?php ad("250x250",1,1); ?></td>
		</tr>
		<tr>
			...
			<table border="0" cellpadding="5" id="whitetext" width="90%" style="font-size:18px; ">
				<tr>
					...
					<td valign="middle" colspan="2" ><strong>About The Cricket Wizard</strong></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td colspan="2">The Cricket Wizard was designed and developed by Aaron Zame.  Aaron was educated at Otago University.</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td><img src="images/zame.jpg" alt="Aaron Zame" /></td>
					<td style="padding-left:40px; padding-right:40px; text-align:justify; ">
		...
		<tr>
			<td align="center" colspan="2"><?php ad("468x60",1,1); ?></td>
		</tr>
		<!--
		<tr>
			<td align="center" colspan="2" style="padding-top:40px; "><a href="sponsorship/advertising.php" target="_blank"><img src="sponsorship/images/Banner.jpg" style="border-color:#CCCCCC; border-style:dashed; border-width:2px;"></a></td>
		</tr>
		-->
		<tr>
			<td align="center" style="padding-bottom:10px; padding-top:30px; " colspan="3"><?php footer(1,1); ?></td>
		</tr>		
		</table>
		</td>
	</tr>
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		...
		<td colspan="2" style="padding-top:10px; "><div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="http://www.thecricketwizard.co.nz" send="false" layout="button_count" width="100" show_faces="false" font=""></fb:like></td>
	</tr>
</table>
</form>
...
<table border="0" cellpadding="3" id="registrationfrm" height="650">
	<tr>
	...
	<?php } ?>	
	<tr>
		<td style="padding-left:15px;" width="147" valign="top">Team name:<font size="+1" color="#C80101";><sup>*</sup></font></td>
		<td>
		<?php 
...
<table cellpadding="0" cellspacing="0" border="0" id="whitetext">
	<tr>
		<td rowspan="2" valign="top" style="padding-right:5px; padding-left:5px; padding-top:120px; "><img src="images/Exclamation.png"></td>
		<td width="90%" style="font-size:20px; padding-bottom:5px; padding-top:120px;" valign="top" id="goldtext"><a href="index.php?id=register" id="goldtext">Register Your Team</a></td>
	</tr>
	<tr>
	...
	<tr>
		<td style="font-size:18px; padding-right:5px; padding-bottom:30px;" valign="top">
		Click <a href="sponsorship/advertising.php" target="_blank">here</a> for advertising opportunities with The Cricket Wizard.
		</td>
	</tr>
	<tr>
		<td rowspan="2" valign="top" style="padding-right:5px; padding-left:5px; "><img src="images/Download.png"></td>
		<td width="90%" style="font-size:20px; padding-bottom:5px; color:#CCCCCC;" valign="top"><a href="downloads.php" target="_blank" style="color:#CCCCCC; ">Downloads</a></td>
	</tr>
	<tr>
